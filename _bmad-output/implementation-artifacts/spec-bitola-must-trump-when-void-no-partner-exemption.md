...
|---|---|---|---|---|
| 1 | Void in led non-trump, opponent already trumped, must over-trump | hand=`[9H, TH, 8D, TD, JD, QD, AD]`, trick=`[(opp, 9C), (partner, QH), (opp, 7C)]`, trump=H, ledSuit=C, mySeat=Red(opp partner of QH player) | `[TH]` only? → No, both `9H` and `TH` over-trump QH(2). Expected `[9H, TH]`. | **img_two** scenario. Highest trump on table = QH(rank 2). 9H(6), TH(4) both > 2 → both legal. Diamonds illegal. |
