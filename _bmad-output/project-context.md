...
- **Belot bonus requires player announcement** — when a player plays trump K or Q and holds the other, UI prompts for announcement. If not announced, no bonus. Server validates against player's hand
