...
export function QuickPlayTile({ onClick, disabled }: Props) {
  ...
  return (
    <button
      ...
      className="group/qp relative flex items-center gap-4 overflow-hidden rounded-[var(--radius-lg)] border border-accent/40 bg-[linear-gradient(135deg,var(--accent-soft)_0%,rgba(25,101,54,0.04)_60%,var(--surface)_100%)] px-5.5 py-4.5 text-left text-ink shadow-[0_0_0_1px_rgba(25,101,54,0.08)_inset,0_14px_36px_-22px_rgba(25,101,54,0.80)] transition-transform hover:-translate-y-0.5 disabled:opacity-60"
    >
